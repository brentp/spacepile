...
from **duplex** sequencing, pac-bio **CCS**, or nanopore [**cyclomics**](https://cyclomics.com/).
The multi-alignments are *spaced* into matricies that can then be sent to any deep-learner.

Note that this is done nicely in [deepconsensus](https://github.com/google/deepconsensus), but that is
specific to PacBio and (likely) less efficient at extraction.
